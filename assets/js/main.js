jQuery(function ($) {
  ...
  // Crawler Schedule
  $("#save_crawl_apii_schedule").on("click", () => {
    ...
    $.ajax({
      ...
      type: "POST",
      data: {
        action: "crawl_apii_save_settings",
        pageFrom,
        pageTo,
        filterType,
        filterCategory,
  ...
  $("#crawl_apii_schedule_enable").on("click", (e) => {
    let enable = $("#crawl_apii_schedule_enable").is(":checked");
    $.ajax({
      url: ajaxurl,
      type: "POST",
      data: {
        action: "crawl_apii_schedule_enable",
        enable
      },
      success: function (res) {
      },
  ...
  $("#save_crawl_apii_schedule_secret").on("click", (e) => {
    let secret_key = $("input[name='crawl_apii_schedule_secret']").val();
    $.ajax({
      url: ajaxurl,
      type: "POST",
      data: {
        action: "save_crawl_apii_schedule_secret",
        secret_key
      },
      success: function (res) {
        alert("Lưu thành công!");
